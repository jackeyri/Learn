...
{
public:
	CFractalDragon(CPoint start, CPoint end, 
				   int step, CColor cc )
	{
		m_start = start;
		m_end = end;
...
protected:
	bool IsLeft(CPoint &ptA,
				CPoint &ptB,
				CPoint &ptC);
	double GetLength(CPoint &pt1,
					 CPoint &pt2);
	CPoint GetCenter(CPoint &pt1,
					 CPoint &pt2);
	CPoint GetVerticalCenter(CPoint &start,
							 CPoint &end,
							 bool isLeft);
